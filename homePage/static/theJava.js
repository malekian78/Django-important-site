...
const setSliderMax = () => {
    ...
    console.log("Setting slider max to", dur);
    seekSlider.max = dur;
}
...
const displayBufferedAmount = () => {
    ...
    if (audio.buffered.length > 0) {
        ...
        // Optional: Reset or hide buffered width if nothing is buffered
...
seekSlider.addEventListener('change', () => {
    console.log("seekSlider.value:", seekSlider.value, typeof(seekSlider.value));
    console.log("audio.currentTime BEFORE:", audio.currentTime);
    audio.currentTime = seekSlider.value;
    // audio.currentTime = 100.025;
